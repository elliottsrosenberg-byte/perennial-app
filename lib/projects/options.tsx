...
// The custom-color picker for project status/type/priority draws from the
// canonical 10-color palette (lib/ui/palette.ts) — the single source for all
// user-customizable colors across the app.
export const OPTION_PALETTE: { name: string; value: string }[] = [...PALETTE_SWATCHES];
