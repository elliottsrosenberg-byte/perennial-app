...
const STEPS: Step[] = [
  {
    ...
    body:    "Pull your real calendar in so it lives next to your tasks. Both providers are read-only — Perennial reads events to display them and to log meeting activity against matched contacts. Skip if you'd rather use Perennial standalone.",
  ...
  },
  {
    ...
    title:   "Drop a task on any day",
    body:    "Hit + Task to capture anything with a due date. It shows on the calendar and rolls up to its project or contact too. Most people start by adding a follow-up they keep forgetting.",
    hint:    "Waiting for you to click + Task…",
  ...
  },
  {
    ...
    anchor:   null,
    title:    "Take it in.",
    body:     "Left rail holds the mini-month, upcoming tasks, and your integrations. The main week grid shows tasks (all-day band) and synced events (time grid). The Today rail at the top surfaces anything due today or overdue. Look around — hit Next when you're ready.",
    advance:  "next",
    freeRoam: true,
  },
  {
    ...
    body:     "Ash sees your calendar, project deadlines, and outreach follow-ups together. Ask it to plan your week, surface what's slipping, or block time for deep work on a specific project.",
    advance:  "next",
    spotlight: false,
